...
export class AppComponent implements AfterViewInit, OnDestroy {
  ...
  constructor() {
    ...
    this.geminiService.setProxyConfig('https://server-992v86mwg-austins-projects-4714fb4e.vercel.app', 'necrometer-client-token-a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6');
